...
//	typename vector<type, alloc>::const_reference operator[](typename vector<type, alloc>::size_type pos) const
	...
	// ~vec() має автоматом запустити деструктор базового класу
