...
void Var::assign()
{
	if (!indexator || type==XS)
		return;

	if (Xvar[symbIndex] < '0' || Xvar[symbIndex] > '9')
		throw std::invalid_argument(std::string("Invalid argument by operator[]. \"") + Xvar[symbIndex] + "\" is not a number!");
