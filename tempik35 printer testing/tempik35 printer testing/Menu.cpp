...
Menu::Menu(std::mutex &mu, WORD actMCol, WORD actPCol, WORD inactMCol, WORD inactPCol)
: mut(mu), activeMenuColor(actMCol), activePunctColor(actPCol), inactiveMenuColor(inactMCol), inactivePunctColor(inactPCol)
{
	Menushka m;
