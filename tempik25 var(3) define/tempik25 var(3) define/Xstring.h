...
public:
	...
	friend int& operator+=(int &i, const Xstring& v);
	friend double& operator+=(double &d, const Xstring& v);
	...
	friend bool operator>(const int &i, const Xstring& v);
	friend bool operator>(const double &d, const Xstring& v);
