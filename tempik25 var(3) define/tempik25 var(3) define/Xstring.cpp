...
int& operator+=(int &i, const Xstring& v)
{
	return i += atoi(v.c_str());
}

double& operator+=(double &d, const Xstring& v)
{
	return d += atof(v.c_str());
}
...
bool operator>(const int &i, const Xstring& v)
{
	return i > atoi(v.c_str());
}

bool operator>(const double &d, const Xstring& v)
{
	return d > atof(v.c_str());
}
